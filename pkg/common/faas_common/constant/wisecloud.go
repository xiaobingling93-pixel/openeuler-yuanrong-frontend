...
// header constant key for caas
const (
	CaaSHeaderTraceID   = "X-Caas-Trace-Id"
	CaaSHeaderRequestID = "X-Cff-Request-Id"
)
...
const (
	...
	// CloudMapId define in wiseCloud about cloudMap id
	CloudMapId = "X_WISECLOUD_CLOUDMAP_ID"
)
